define([
    ...
    return declare("ConactApp.widget.ConactApp", [_WidgetBase, _TemplatedMixin], {
        ...
        getCustomerIntoField: function (customerList) {
            ...
            var preLoadValue = [];
            var preLoadFromValue = this._contextObj.jsonData.attributes.From.value;
            var preLoadToValue = this._contextObj.jsonData.attributes.To.value;
            if (this.maxItems === 1) {
                preLoadValue.push(this._contextObj.jsonData.attributes.From.value);
            } else {
                var toValue = this._contextObj.jsonData.attributes.To.value;
